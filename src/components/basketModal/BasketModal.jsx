            ...
            {isOpen && (<div className="basket-modal">
                    <div className="modal-content">
                        ...
                        {basketItems.length === 0 ? (<div className="empty-cart">
                                <h4 className="empty-cart__title">Корзина пустая</h4>
                                <img className="empty-cart__img" src={EmptyImg} alt="Пустая корзина"/>
                            </div>) : (<>
                                <ul className="basket-list">
                                    {basketItems.map((item) => (<div key={item.id} className="basket-item">
                                            ...
                                            <div className="item-details">
                                                ...
                                                <div className="price-details">
                                                    <p className="item-price">Сумма: </p>
                                ...
                                <div className="basket-footer">
                                    <p className="total-amount">Общая сумма: <span>{totalAmount} Сом</span></p>
